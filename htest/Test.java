...
public class Test {
    public static void main(String[] args) {
        ...
        Circle c2 = new Circle(new Point(9, -6), 2);
        GeometricObject t1 = new Triangle(new Point(1, 2), new Point(1, 3), new Point(5, 0));
        Triangle t2 = new Triangle(new Point(-1, -3), new Point(-8, 3), new Point(1, 0));
